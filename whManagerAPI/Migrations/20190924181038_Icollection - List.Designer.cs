...
namespace whManagerAPI.Migrations
{
    ...
    [Migration("20190924181038_Icollection - List")]
    partial class IcollectionList
    {
            ...
            modelBuilder.Entity("whManagerLIB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CompanyId = 1, DateCreated = new DateTime(2019, 9, 24, 20, 10, 38, 254, DateTimeKind.Local), EmailAddress = "admin@admin.net", PasswordHash = "r1kZZNn1IY1l+VNGaPH7L3nrT+J4F8da4jluq8dUsRU=", PasswordSalt = "a76+a3j+TIsWsPRzge8Ony7skqEZJ6w1mnye7eiIw2IGYLNKYWyvACkcpvOQ/xOw2HC5YuGnsTPh2HZqFr5uIQ==", Role = "Administrator" }
                    );
                });
