...
namespace whManagerAPI.Migrations
{
    ...
    [Migration("20190924191240_Data annotation changes")]
            ...
            modelBuilder.Entity("whManagerLIB.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CompanyId = 1, DateCreated = new DateTime(2019, 9, 24, 21, 12, 39, 792, DateTimeKind.Local), EmailAddress = "admin@admin.net", PasswordHash = "uvzY5VNMrbXvEmBmrTYfEDlQolvk4suktMamnqAj7eo=", PasswordSalt = "cBA/G1Y42zPwjmJqYkX03LZUpVxXvdk5N3bVVq6gqsH2EpnZha4olLyDfmrU3ZvCJoK3pW7PRQAw+eguwljQig==", Role = "Administrator" }
                    );
                });
